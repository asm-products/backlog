angular.module('googleApi', [])
    ...
    .service("googleMail", function(googleApiBuilder, $rootScope) {
        ...
        var self = this;
        var itemExtractor = function(resp) { return resp.messages; };

        googleApiBuilder.afterClientLoaded(function() {
            gapi.client.load('gmail', 'v1', function() {
                console.log(itemExtractor);
                self.listMessages = googleApiBuilder.build(gapi.client.gmail.users.messages.list, itemExtractor);
